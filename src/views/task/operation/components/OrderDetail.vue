...
export default {
  ...
  methods: {
    async getWorkOrderDetail(taskId) {
      ...
      // console.log(res)
      this.orderInfo = data
      this.orderInfo.createTime = this.orderInfo.createTime.replace('T', ' ')
      this.orderInfo.updateTime = this.orderInfo.updateTime.replace('T', ' ')
      this.orderInfo.createType = this.orderInfo.createType === 0 ? '自动' : '手动'
